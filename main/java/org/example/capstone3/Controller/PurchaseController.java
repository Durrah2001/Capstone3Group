...
public class PurchaseController {
    ...
    @PutMapping("/update/{purchase_id}")
    public ResponseEntity updatePurchase(@PathVariable Integer purchase_id, @RequestBody @Valid PurchaseDTO_In purchaseInDTO) {
        purchaseService.updatePurchase(purchase_id, purchaseInDTO);
        return ResponseEntity.status(200).body(new ApiResponse("purchases updated"));
    }
